      ...
      <ul className="space-y-2">
        {items.map((n) => {
          ...
          return (
            <li
              key={n.id}
              className="flex items-start gap-2 rounded-sm bg-bg px-3 py-2.5"
            >
              ...
              <button
                ...
                className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-sm text-primary transition-colors hover:bg-surface"
              >
